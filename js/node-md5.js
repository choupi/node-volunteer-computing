// from "https://raw.github.com/blueimp/JavaScript-MD5/master/js/md5.min.js"
...
function job() {
    ...
    encrypt = md5(cypher);
    var postData=JSON.stringify({'body':{'cypher':cypher, 'encrypt': encrypt}});
    var options = {
      hostname: hostname,
      port: 8124,
      path: '/submit/?ranbow',
    ...
    //req.write(postData);
    req.end(postData);
    console.log(cypher+':'+encrypt+','+postData.length);
}
job();
